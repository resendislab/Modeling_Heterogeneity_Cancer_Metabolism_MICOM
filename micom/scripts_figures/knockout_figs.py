...
ko = pd.read_csv("./data/knockouts_scan_31.csv", index_col=0)




#ko1=ko['sample']=='com_0.5739_0.2739_0.1522'
#ko2=ko['sample']=='com_0.0902_0.391_0.5188'
...
pl.save("./figures/knockout_counts_31.svg", width=4, height=12)

'''graph = nx.from_pandas_edgelist(
    pos[pos.change.abs() > 1e-3], "knocked", "genus", "change"
)
