...
rates = (
    pd.read_csv("./data/tradeoff_scan_31.csv")
...
pl.save("figures/gcs_scan_31.svg", width=12, height=4)
...
pl.save("figures/rate_vs_abundance_scan_31.png", width=3, height=3, dpi=300)

subset = rs.id.unique()[58:70]
free_subset = (
...
pl.save("figures/rate_vs_abundance_individual_scan_31.svg", width=6, height=5)